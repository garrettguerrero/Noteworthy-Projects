...
def choose_class(event):
    ...
    if class_drop.get() != 'Bard' and class_drop.get() != 'Ranger' and class_drop.get() != '':
        prof_1['state'] = 'enabled'
        prof_2['state'] = 'enabled'
        prof_3['state'] = 'disabled'
    elif class_drop.get() == 'Bard' or class_drop.get() == 'Ranger':
        prof_1['state'] = 'enabled'
        prof_2['state'] = 'enabled'
...
def roll_dice():
    ...
    for num in dice_roll:
        dice_roll_copy.append(num)
    
    roll_button['state'] = 'disabled'
    tk.Label(page_5, text = dice_roll).grid(row = 0, column = 1)

    strn_input['values'] = dice_roll
    dex_input['values'] = dice_roll
    con_input['values'] = dice_roll
    intl_input['values'] = dice_roll
    wis_input['values'] = dice_roll
    cha_input['values'] = dice_roll
...
def choose_die(event):
    ...
    if strn_input.get() != '' and strn_input['state'] == 'enabled':
        dice_roll.remove(int(strn_input.get()))
        dex_input['values'] = dice_roll
        con_input['values'] = dice_roll
        intl_input['values'] = dice_roll
        wis_input['values'] = dice_roll
    ...
    elif dex_input.get() != '' and dex_input['state'] == 'enabled':
        dice_roll.remove(int(dex_input.get()))
        strn_input['values'] = dice_roll
        con_input['values'] = dice_roll
        intl_input['values'] = dice_roll
        wis_input['values'] = dice_roll
    ...
    elif con_input.get() != '' and con_input['state'] == 'enabled':
        dice_roll.remove(int(con_input.get()))
        strn_input['values'] = dice_roll
        dex_input['values'] = dice_roll
        intl_input['values'] = dice_roll
        wis_input['values'] = dice_roll
    ...
    elif intl_input.get() != '' and intl_input['state'] == 'enabled':
        dice_roll.remove(int(intl_input.get()))
        strn_input['values'] = dice_roll
        con_input['values'] = dice_roll
        dex_input['values'] = dice_roll
        wis_input['values'] = dice_roll
    ...
    elif wis_input.get() != '' and wis_input['state'] == 'enabled':
        dice_roll.remove(int(wis_input.get()))
        strn_input['values'] = dice_roll
        con_input['values'] = dice_roll
        intl_input['values'] = dice_roll
        dex_input['values'] = dice_roll
    ...
    elif cha_input.get() != '' and cha_input['state'] == 'enabled':
        dice_roll.remove(int(cha_input.get()))
        strn_input['values'] = dice_roll
        con_input['values'] = dice_roll
        intl_input['values'] = dice_roll
        wis_input['values'] = dice_roll
...
def reset_options():
    ...
    strn_input['values'] = dice_roll_copy
    dex_input['values'] = dice_roll_copy
    con_input['values'] = dice_roll_copy
    intl_input['values'] = dice_roll_copy
    wis_input['values'] = dice_roll_copy
    cha_input['values'] = dice_roll_copy
...
strn_input.bind("<<ComboboxSelected>>", choose_die)
...
dex_input.bind("<<ComboboxSelected>>", choose_die)
...
con_input.bind("<<ComboboxSelected>>", choose_die)
...
intl_input.bind("<<ComboboxSelected>>", choose_die)
...
wis_input.bind("<<ComboboxSelected>>", choose_die)
...
cha_input.bind("<<ComboboxSelected>>", choose_die)

# create a button that allows the user to reset ability score modifiers
reset_button = tk.Button(page_5, text = "Reset", command = reset_options)
reset_button.grid(row = 10, columnspan = 2, sticky = 's')
